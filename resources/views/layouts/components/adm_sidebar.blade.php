    ...
    <li class="nav-item">
        ...
        <div id="collapseCatalog" class="collapse {{ isset($menu_name) ? ($menu_name == 'Sistema')?'show':'':'' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="">Municipios</a>
                <a class="collapse-item" href="">Localidades</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFunctionaryCatalog"
            aria-expanded="true" aria-controls="collapseFunctionaryCatalog">
            <i class="fas fa-fw fa-cogs"></i>
            <span>Funcionarios</span>
        </a>
        <div id="collapseFunctionaryCatalog" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Todos</h6>
                <a class="collapse-item" href="">Tipos de funcionario</a>
                <a class="collapse-item" href="">Periodos</a>
                <a class="collapse-item" href="">Comisiones</a>
                <a class="collapse-item" href="">Tipos de comisiones</a>
            </div>
        </div>
    </li>
